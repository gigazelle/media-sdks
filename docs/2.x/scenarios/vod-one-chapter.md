...
Unless specified, the network calls in this scenario are the same as the calls in the [VOD playback with no ads](vod-no-intrs-details.md) scenario. The network call happens at the same time, but the payload is different. 
...
|  The content plays.  |  | Content Heartbeats  | This network call is exactly the same as the [VOD playback with no ads](vod-no-intrs-details.md) scenario.  |
|  The content is complete.  | `trackComplete`  | Heartbeat Content Complete  | This network call is exactly the same as the [VOD playback with no ads](vod-no-intrs-details.md) scenario.  |
...
## Sample code, chapter in the middle

In this scenario, part of the VOD content is a chapter.

![](../../../help/use-cases/scenarios/assets/chapter-regular-playback.png)
